...
def advice(temp, rain):
    ...
    if temp > 30:
        ...
        return "The weather look good. Enjoy your day! Well, untill you encounter a hacking Leo, then run for your life."
...
if st.button("Check Weather"):
    ...
    if place:
        ...
        rain = weather["daily"]["precipitaion_probability_max"][0]
